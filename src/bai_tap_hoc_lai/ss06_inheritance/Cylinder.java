...
public class Cylinder extends Circle {   // sử dụng extends để lớp Cylinder kế thừa lại lớp cỉcle.
    ...
    public double getVolume() {        // đây là overload để mở rộng thêm hành vi tính thể tích
